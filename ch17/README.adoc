...
[source,sh]
----
% java -jar target/service-registry-0.0.17-SNAPSHOT.jar
----
...
[source,sh]
----
% java -jar target/config-server-0.0.17-SNAPSHOT.jar
----
...
[source,sh]
----
% java -jar target/boot-admin-server-0.0.17-SNAPSHOT.jar
----
...
[source,sh]
----
% java -jar target/hystrix-dashboard-0.0.17-SNAPSHOT.jar
----
...
[source,sh]
----
% java -jar target/turbine-server-0.0.17-SNAPSHOT.jar
----
...
[source,sh]
----
% java -jar target/ingredient-service-0.0.17-SNAPSHOT.jar
----
...
[source,sh]
----
% java -jar target/ingredient-client-0.0.17-SNAPSHOT.jar
----
...
[source,sh]
----
% java -jar target/taco-service-0.0.17-SNAPSHOT.jar
----
...
[source,sh]
----
% java -jar -Dspring.profiles.active=webclient target/ingredient-client-0.0.17-SNAPSHOT.jar
----
...
[source,sh]
----
% java -jar -Dspring.profiles.active=feign target/ingredient-client-0.0.17-SNAPSHOT.jar
----
...
This should create a taco in the taco service, but most important to the discussion in chapter 17, it should also enable you to see the "taco-stats":"count" information in the `/actuator/info` endpoint as well as view the "tacocloud" metrics from the `/metrics/tacocloud` endpoint.
...
To view the Spring Boot Admin Server, navigate to http://localhost:9090 in your web browser. Per the security configuration described in section 17.3.1 in the book, you will be prompted to login. The username is "admin" and the password is "53cr3t".

=== What's missing/broken...

As stated earlier, this folder only contains code directly relevant to the discussion in chapter 17 and does not contain the complete Taco Cloud application. At some future time, I may build out the complete Taco Cloud application as a collection of microservices.
